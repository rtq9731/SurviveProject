...
public class RetiredContentGateTests
{
        ...
        폐기된_세계관 =
    {
        ...
        ("떠 있는 땅덩이",       new[] { "부유" + "섬", "부유 " + "섬" },         false, 11),

        // 군도가 없으므로 군도의 구역 이름도 없다
        ("군도 구역 이름",       new[] { "A" + "섬", "B" + "섬" },               false, 41),
