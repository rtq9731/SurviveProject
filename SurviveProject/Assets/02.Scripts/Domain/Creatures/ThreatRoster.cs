...
namespace Survive.Creatures
{
    ...
    public readonly struct ThreatSighting
    {
        ...
        public ThreatSighting(float distance) : this(distance, false)
        {
        }

        public ThreatSighting(float distance, bool inLight)
        {
            Distance = distance;
            InLight = inLight;
        }
    ...
    public readonly struct ThreatRoster
    {
                                        ...
                                        bool selfInLight = false)
        {
            ...
            return new CreatureSenses(t.Distance, aggroLeft, stateTimer, selfInLight, t.InLight);
        }
