...
namespace Survive.Harvesting
{
    ...
    /// 배터리는 스크랩에서 나온다(추출 레시피 스크랩 5개 → 셀 1개). 그런데 A섬에
    ...
    public static class HarvestRespawnRule
    {
        ...
        // 아래 둘을 고르면 A섬 전체의 스크랩 공급이 정확히 분당 14.4개가 되고,
        ...
        /// <summary>「매크로늄 석영」— 300초. 이미 그렇게 서 있던 값이다(B섬용).</summary>
        ...
        ///
        /// <list type="number">
        /// <item><b>노동은 게이트가 아니다</b>(기획서의 관통 원칙). 외계 합금은
        ...
        ///   70% 확률로 1~2개가 나온다(LootTables/Scythe). 즉 외계 합금이 더
