// 두 갈래가 같은 날 같은 이름으로 도감 로케일 검사를 각각 만들었다.
// 보는 것이 다르므로 둘 다 남긴다 — 이쪽은 CodexCatalog가 내놓는 본문
// (탭 이름·관측 보고·잠긴 줄 안내문), E2ECodexLocale은 화면 껍데기와
// 목록 줄의 물질 이름을 본다.
...
namespace Survive.Testing
{
    ...
    /// </summary>
    public static class E2ECodexCatalogLocale
    {
