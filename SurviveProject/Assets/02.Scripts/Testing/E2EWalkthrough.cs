...
namespace Survive.Testing
{
    ...
    public static class E2EWalkthrough
    {
        ...
        public static IEnumerator FullRun()
        {
            ...
            // ── 목표 1·2: 걸어서 지대에 들어간다 ────────────────
            // 트리거는 44m 폭의 판이다. 중심에 설 이유는 없고 — 그 자리는 스폰에서
            // 한참 떨어진 바위 위다 — 게임이 요구하는 것은 판을 밟는 것뿐이다.
            ...
            // ── 목표 6: 강 건너 광맥, 그리고 돌파정을 만들어 내려간다 ──
            //
            // 예전에는 외계 장치까지 걸어가 기동했다(백로그 36 이전). 지금 종막은 하강이고,
            // 그 무대인 짙은 액면층과 4번 섬의 매크로늄 석영은 아직 씬에 없다 —
            ...
            // 돌파 설계는 연구대의 산출물이고(백로그 38) 소재인 유물은 낫이 순찰하다
            // 흘린다(백로그 39). 배선은 다 있지만 낫의 서식지가 아직 씬에 없어
            // 걸어서 닿을 곳이 없다 — 매크로늄 석영과 똑같은 사정(§8-4)이므로 같은
