...
{
    /// <summary>
    /// A섬에 서 있는 채집물이 <b>화면에서도</b> 제 이름으로 불리는가.
    ///
    /// <b>왜 이 시나리오가 필요한가.</b> 2026-08-07 검토 회신 ①이 A섬에서 매크로늄을
    /// 없앴다. A섬은 스크랩과 기계 부품만 나오는 학습·준비 구간이고 새 물질은
    /// B섬부터다. 그런데 A섬 씬에는 매크로늄의 이름을 단 채집물이 열세 곳 서 있었다 —
    /// 실제로 떨구는 것은 매크로늄이 아니라 <b>외계 합금</b>인데도. 물건은 맞고
    /// 화면만 어긋난 상태였다.
    ///
    ...
    public static class E2EOreVeinName
    {
        ...
        /// <summary>A섬에서 사라진 말. 이 낱말이 프롬프트에 다시 나오면 실패다.</summary>
